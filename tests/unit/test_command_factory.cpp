...
void assert_command(const Command &cmd, Commandtype expected_type, 
                    const std::vector<uint8_t> &expected_payload, const std::string &description)
{
...
void test_system_commands()
{
  ...
  assert_command(
      ...
      Commandtype::RELEASE_PROTECTION,
      {0x00, 0x01},
  ...
  assert_command(
      CommandFactory::calibrate_encoder(),
      Commandtype::CALIBRATE_ENCODER,
      {0x00},
      "calibrate_encoder() - Start calibration (0x00)");

  // Test: Emergency Stop (Command 0xF7)
  assert_command(
      CommandFactory::emergency_stop(),
  ...
  assert_command(
      CommandFactory::set_zero(),
      Commandtype::SET_ZERO,
      {},
...
void test_configuration_commands()
{
  ...
  assert_command(
      CommandFactory::set_subdivision(16),
      Commandtype::SET_SUBDIVISION,
      {16},
      "set_subdivision(16) - Set 16 microsteps");

  assert_command(
      CommandFactory::set_subdivision(32),
      Commandtype::SET_SUBDIVISION,
      {32},
  ...
  assert_command(
      CommandFactory::set_en_pin_active(EnPinActive::EN_LOW),
      Commandtype::SET_EN_PIN_ACTIVE,
      {0x00},
      "set_en_pin_active(LOW) - EN active LOW");

  assert_command(
      CommandFactory::set_en_pin_active(EnPinActive::EN_HIGH),
      Commandtype::SET_EN_PIN_ACTIVE,
      {0x01},
  ...
  assert_command(
      CommandFactory::set_auto_screen_off(true),
      Commandtype::SET_AUTO_SCREEN_OFF,
      {0x01},
      "set_auto_screen_off(true) - Enable auto-off");

  assert_command(
      CommandFactory::set_auto_screen_off(false),
      Commandtype::SET_AUTO_SCREEN_OFF,
      {0x00},
  ...
  assert_command(
      CommandFactory::set_lock_keys(false),
      Commandtype::SET_LOCK_KEYS,
      {0x00},
      "set_lock_keys(false) - Unlock keys");

  assert_command(
      CommandFactory::set_lock_keys(true),
      Commandtype::SET_LOCK_KEYS,
      {0x01},
  ...
  assert_command(
      CommandFactory::set_control_mode(ControlMode::SR_VFOC),
  ...
  assert_command(
      CommandFactory::enable_motor(true),
      Commandtype::ENABLE_MOTOR,
      {0x01},
      "enable_motor(true) - Enable motor");

  assert_command(
      CommandFactory::enable_motor(false),
      Commandtype::ENABLE_MOTOR,
      {0x00},
...
void test_homing_commands()
{
  ...
  assert_command(
      CommandFactory::set_homing_parameters(
          EndstopTrigger::TRIGGER_LOW,
          Direction::CCW,
          Speed::from_rpm(60, nullptr),
          true),
      Commandtype::SET_HOMING_PARAMETERS,
      {0x00, 0x01, 0x00, 0x3C, 0x01},
  ...
  assert_command(
      CommandFactory::set_nolimit_homing_params(
          Position::from_ticks(2000),
          false,
          1000),
      Commandtype::SET_NOLIMIT_HOMING_PARAMS,
      {0x00, 0x00, 0x07, 0xD0, 0x00, 0x00, 0x03, 0xE8},
...
void test_movement_commands()
{
  ...
  assert_command(
      CommandFactory::move_position_mode_2(
          Position::from_ticks(1000),
          Speed::from_rpm(100, nullptr),
          Acceleration::from_internal(50)),
      Commandtype::MOVE_POSITION_MODE_2,
      {0x00, 0x32, 0x00, 0x64, 0x00, 0x00, 0x03, 0xE8},
  ...
  assert_command(
      CommandFactory::move_position_mode_1(
          Direction::CW,
          Speed::from_rpm(200, nullptr),
          Acceleration::from_internal(100),
          Position::from_ticks(5000)),
      Commandtype::MOVE_POSITION_MODE_1,
      {0x00, 0x00, 0xC8, 0x64, 0x00, 0x00, 0x13, 0x88},
  ...
  assert_command(
      CommandFactory::move_speed_mode(
          Speed::from_rpm(150, nullptr),
          Acceleration::from_internal(75)),
      Commandtype::MOVE_SPEED_MODE,
      {0x01, 0x00, 0x96, 0x4B},
  ...
  assert_command(
      CommandFactory::stop_speed_mode(
          Acceleration::from_internal(50)),
      Commandtype::MOVE_SPEED_MODE,
      {0x00, 0x32, 0x00, 0x00},
      "stop_speed_mode() - Deceleration stop with acc=50");

  // Test: Stop Position Mode 2 (Command 0xFF, 1 byte)
  // Payload: [deceleration]
  assert_command(
      CommandFactory::stop_position_mode_2(
          Acceleration::from_internal(100)),
      Commandtype::STOP_POSITION_MODE_2,
      {0x64},
      "stop_position_mode_2() - Stop with decel=100");
}
...
void test_edge_cases()
{
  ...
  assert_command(
      CommandFactory::move_position_mode_2(
          Position::from_ticks(2147483647), // Max int32
          Speed::from_rpm(100, nullptr),
          Acceleration::from_internal(50)),
      Commandtype::MOVE_POSITION_MODE_2,
      {0x00, 0x32, 0x00, 0x64, 0x7F, 0xFF, 0xFF, 0xFF},
  ...
  assert_command(
      CommandFactory::move_position_mode_2(
          Position::from_ticks(-1000),
          Speed::from_rpm(50, nullptr),
          Acceleration::from_internal(25)),
      Commandtype::MOVE_POSITION_MODE_2,
      {0x00, 0x19, 0x00, 0x32, 0xFF, 0xFF, 0xFC, 0x18},
      "move_position_mode_2() - Negative position (-1000)");

  // Test: Zero values
  assert_command(
      CommandFactory::move_position_mode_2(
          Position::from_ticks(0),
          Speed::from_rpm(0, nullptr),
  ...
  assert_command(
      CommandFactory::move_speed_mode(
          Speed::from_rpm(3000, nullptr),
          Acceleration::from_internal(255)),
      Commandtype::MOVE_SPEED_MODE,
      {0x01, 0x0B, 0xB8, 0xFF},
  ...
  assert_command(
      CommandFactory::set_working_current(65535), // Max uint16
      Commandtype::SET_WORKING_CURRENT_RUNTIME,
      {0xFF, 0xFF},
